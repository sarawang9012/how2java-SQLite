 ...
 *
 * @Author Sara Wang
 * @Create 2023/11/14 14:55
 * @Version 1.0
 */

@Component
@Configuration
@EnableJpaRepositories(basePackages = "com.how2java.springboot.dao")
...
public class DbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        //set entities package name
        em.setPackagesToScan(new String[]{"com.how2java.springboot.pojo"});
    ...
    final Properties additionalProperties() {
        ...
        if (env.getProperty("hibernate.show_sql") != null) {
            hibernateProperties.setProperty("hibernate.show_sql", env.getProperty("hibernate" +
                    ".show_sql"));
        }
